...
class MaidSummary extends skynode_1.DomNode {
    ...
    async load() {
        ...
        this.append(skynode_1.el("", `Maid #${this.maidId}`), skynode_1.el("", `Origin Power: ${maid.originPower}`), skynode_1.el("", `Supported LP Token Amount: ${ethers_1.utils.formatEther(maid.supportedLPTokenAmount)}`), skynode_1.el("a.support-button", "Support", {
            click: async () => {
