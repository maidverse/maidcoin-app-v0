...
class TestLPToken {
    constructor() {
        ...
        Layout_1.default.current.content.append(this.container = skynode_1.el("#test-lp-token", skynode_1.el("h2", "Test LP Token"), this.info = skynode_1.el(".info", skynode_1.el(".loading", "Loading...")), skynode_1.el(".control", skynode_1.el("a.mint-button", "Mint", {
            click: async () => {
