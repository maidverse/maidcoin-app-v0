...
class Layout {
    constructor() {
        ...
        Layout.current = this;
        skynode_1.BodyNode.append(this.container = skynode_1.el("#layout", skynode_1.el("header", skynode_1.el(".main", skynode_1.el("h1", skynode_1.el("a", skynode_1.el("img.logo", { src: "/images/logo.png" }), { click: () => skyrouter_1.SkyRouter.go("/") })), skynode_1.el("a.menu-button.fas.fa-bars", {
            click: (event, button) => {
