...
class Nurse {
    constructor() {
        Layout_1.default.current.content.append(this.container = skynode_1.el("#nurse", "Nurse!", this.raidList = skynode_1.el(".raid-list"), this.nurseList = skynode_1.el(".nurse-list")));
        this.loadRaids();
        this.loadNurses();
    }
    async loadRaids() {
