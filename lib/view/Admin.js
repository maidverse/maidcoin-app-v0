...
class Admin {
    constructor() {
        ...
        })), skynode_1.el(".create-nurse-type-form", partCountInput = skynode_1.el("input", { placeholder: "Part Count" }), destroyReturnInput = skynode_1.el("input", { placeholder: "Destroy Return" }), powerInput = skynode_1.el("input", { placeholder: "Power" }), skynode_1.el("a.create-nurse-type-button", "Create Nurse Type", {
            click: async () => {
