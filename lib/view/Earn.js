...
const CloneNurse_1 = __importDefault(require("../component/CloneNurse"));
...
class Earn {
    constructor() {
        Layout_1.default.current.content.append(this.container = skynode_1.el("#earn", "Earn!", this.poolList = skynode_1.el(".pool-list"), this.nurseList = skynode_1.el(".nurse-list")));
        this.loadPools();
    }
    async loadPools() {
